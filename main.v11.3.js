...
const UIManager = {
    showSection(id) {
        ...
        subtitle.innerHTML = `${state.context.activeClient} • ${state.context.activePeriod} <span class="version-badge-neon">v11.3.0 FORCE-SYNC</span>`;
...
const App = {
    init() {
        console.log(`Execution Compass v11.3.0 [FORCE-SYNC] - Hard Reset Active`);
